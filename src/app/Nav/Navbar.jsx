...
const Navbar = () => {
  ...
  return (
    <div className='z-50 fixed flex justify-center w-full text-white font-bold'>
      ...
      <div
      onClick={toggleNav}
      className='  md:hidden absolute top-5 right-[2rem]
      ...
      <div className={`fixed left-0 top-0 w-full h-full bg-black/90 transform transition-transform duration-300 ${nav ?  "translate-x-10" : "-translate-x-full"}`}>
